            ...
            <div className="Dados-Pagamento">
                ...
                <div className="flex horizontal">
                    ...
                    <div className="flex-1">
                        <FormSimples
                            ...
                            name="CVVCartao"
                            placeholder="XXX"
                            label="Codigo de Segurança do Cartão"
                ...
                <div className="flex">
                    <select name="parcelas">
                        <option>Seleione a quantidade</option>
                        <option value="1"> 1x de R$ 105,00 sem juros  </option>
                        <option value="2"> 2x de R$ 52,50  sem juros </option>
                        <option value="3"> 3x de R$ 35,00  sem juros   </option>
                        <option value="4"> 4x de R$ 26,25  sem juros </option>
